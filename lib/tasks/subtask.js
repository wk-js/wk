...
class SubTask {
  ...
  _execute() {
    ...
    if (canExecute) {
      ...
      this.argv.strict = !!this.options.argv_config
      Object.assign(this.argv.soft_params, this.options.argv)
      this.argv.validate()

      try {
        this.value = this.options.action.call(this, this.argv.params)
      } catch(e) {
        this.fail(e)
      }
