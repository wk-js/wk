...
module.exports = class Namespace {
  ...
  resolveTask(path) {
    ...
    return (ns && ns.tasks[name]) || (this.parent && this.parent.resolveTask(path))
  }
  ...
  getPath( name ) {
    ...
    // Remove root namespace from path
    path.pop()
   ...
   */
  unregisterTask( tsk ) {
    if (this.tasks[tsk.name] === tsk ) {
      delete this.tasks[tsk.name]
    }
  }
